...
class Input {
  ...
  unsigned int Input_Begin(void)
  {
    ...
    unsigned int num_rows, number_of_entries_A;
    unsigned int num_cols, Max_Iter {1000};
    (void) Max_Iter;
